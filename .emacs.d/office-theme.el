...
(custom-theme-set-faces
 ...
 '(highlight ((t (:weight bold :underline (:color nil :style nil)))))
 ...
 '(font-lock-comment-face ((t (:foreground "#ada653"))))
 ...
 '(font-lock-variable-name-face ((t (:foreground "mediumorchid4"))))
